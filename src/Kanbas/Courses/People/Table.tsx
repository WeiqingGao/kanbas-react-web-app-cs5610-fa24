            ...
            <table className="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="wd-total-activity">08:15:27</td> 
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-9-27</td>
                        <td className="wd-total-activity">01:22:42</td> 
                    </tr>
                    <tr>
                        <td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-total-activity">11:58:09</td> 
                    </tr>
                </tbody>
            </table>
        </div> 
